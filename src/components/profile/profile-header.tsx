...
import img from '@/assets/profile_img.svg'
    ...
    return (
        <div>
            <div className="flex items-center justify-between px-10 xl:px-32 py-4 bg-white shadow-md fixed w-full top-0">
                ...
                <Image src={img} width={180} alt='profile_img' priority/>
                ...
                <div className="bg-white w-64 h-full p-4">
                    ...
                    <ul className="space-y-4">
                        {menu.map((item) => (
                            <li key={item.id}>
                                <Link href={item.href} passHref>
                                    <div className="text-lg font-semibold cursor-pointer hover:text-green-500 transition"
                                        onClick={closeDrawer}>
                                        {item.title}
                                    </div>
                                </Link>
